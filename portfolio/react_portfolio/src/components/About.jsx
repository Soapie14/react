...
const About = () => {
    return (
        <div className="bg-black mx-0 flex flex-col items-center justify-center h-[500px] p-4 sm:p-8 md:p-16 lg:p-20 xl:p-24">
            <p className='text-gray-200 text-4xl sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl font-bold mb-4'>About Me</p>
            <p className='text-gray-700 text-center text-sm sm:text-base md:text-lg lg:text-base xl:text-lg'>
