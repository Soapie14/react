...
const Projects = () => {
    return (
        <div className="bg-black text-white py-8">
            <p className='text-white text-4xl text-center sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl font-bold mb-4'>Experience</p>
